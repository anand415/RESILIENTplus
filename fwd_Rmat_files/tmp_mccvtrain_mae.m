function [xgamn10,errall_ga_maemn10,xgamin10,errall_ga_maemin10,xgamn5,errall_ga_maemn5,xgamin5,errall_ga_maemin5,...
    xga1,errall_ga_mae1]=tmpmccvtrain_mae(ii,xgaall,Ctrain)
load Rmat_fwd.mat
load ../vocvalppb.mat
% rng default
...
fun = @(x) (C*x'-d);
funga = @(x) 100*sum(abs((Ctr{jj}*x'-dtr{jj})));
% 
% for uu=1:10
...
tmm=fun(xgamn10(jj,:));
    errall_ga_maemn10(jj,:)=tmm;
    
    
    tmm=fun(xgamin10(jj,:));
    errall_ga_maemin10(jj,:)=tmm;
    
    
    tmm=fun(xgamn5(jj,:));
    errall_ga_maemn5(jj,:)=tmm;
    
    
    tmm=fun(xgamin5(jj,:));
    errall_ga_maemin5(jj,:)=tmm;
    
       tmm=fun(xga1(jj,:));
    errall_ga_mae1(jj,:)=tmm;
% toc
